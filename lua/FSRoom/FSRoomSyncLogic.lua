...
function FSRoomSync:AddCommand(userId, commandType, data)
    ...
    local command = { userId = userId, commandType = commandType, data = data, frameId = self.currentFrame }
...
function FSRoomSync:Update()
    ...
    local frame = { frameId = self.currentFrame, timestamp = TimeMgr.GetS(), commands = self.frameCommands }
