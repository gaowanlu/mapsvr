...
FSRoomIsometricMap.DIRECTION4 = { { x = 0, y = -1 }, { x = 1, y = 0 }, { x = 0, y = 1 }, { x = -1, y = 0 } }

FSRoomIsometricMap.DIRECTION8 = {
    { x = 0, y = -1 }, { x = 1, y = -1 }, { x = 1, y = 0 }, { x = 1, y = 1 }, { x = 0, y = 1 }, { x = -1, y = 1 },
    { x = -1, y = 0 }, { x = -1, y = -1 }
}

FSRoomIsometricMap.TILETYPES = { EMPTY = '0', WALL = '1', BORDER = '2' }
...
function FSRoomIsometricMap:Print()
    print("Isometric Map (" .. self.width
            .. "x" .. self.height
